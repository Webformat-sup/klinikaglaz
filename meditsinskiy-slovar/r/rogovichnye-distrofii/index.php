...
$APPLICATION->SetTitle("Что такое Роговичные дистрофии");
$APPLICATION->SetPageProperty("description", "Выделяют первичные (врожденные или наследственные) и вторичные (приобретенные) дистрофии роговицы.");?><article>
