...
<?if($USER->isAdmin()){?>
	<div class="form-wrapp">
		...
		<div class="desc">Мы перезвоним, ответим на все интересующие вас вопросы и расчитаем стоимость подходящих вам интраокулярных линз</div>

			<div class="button-container">
				<input type="text" placeholder="Имя" />
				<input type="text" placeholder="8 (9хх) ххх-хх-хх" />
				<div class="btn-custom-sign button">Оставить заявку</div>
				<!-- <div class="btn-custom-sign button" data-event="jqm" data-param-id="5" data-name="order_services" data-autoload-service="<?= $arResult['NAME'] ?>">Оставить заявку</div> -->
			</div>
	</div>
<?}?>
