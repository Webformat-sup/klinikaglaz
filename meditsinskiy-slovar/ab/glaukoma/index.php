...
$APPLICATION->SetTitle("Что такое Глаукома");
$APPLICATION->SetPageProperty("description", "Глаукома - аболевание, при котором происходит необратимая атрофия нервных волокон диска зрительного нерва, чаще всего на фоне повышения внутриглазного давления (ВГД).");?><h2>Глаукома</h2>
<p>
