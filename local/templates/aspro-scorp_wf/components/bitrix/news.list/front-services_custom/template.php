...
<?if($arResult['ITEMS'] && $arParams['SHOW_GOODS'] !== 'N'):?>
	...
	<div class="catalog item-views table front" style="display:none;">
		...
		<div class="flexslider unstyled row" data-plugin-options='{"direction": "vertical", "animation": "slide", "directionNav": true, "controlNav" :true, "animationLoop": true, "slideshow": false, "counts": [<?=$countmd?>, <?=$countsm?>, <?=$countxs?>]}'>
						...
						<div class="item<?=($bShowImage ? '' : ' wti')?> custom" id="<?=$this->GetEditAreaId($arItem['ID'])?>"<?=($bBuyButton ? ' data-item="'.$dataItem.'"' : '')?> itemprop="itemListElement" itemscope="" itemtype="http://schema.org/Product">
							...
							<div class="text">
								<div class="cont">
									...
									<?endif;?>
									<div class="prevorder">
										<span class="btn btn-default btn-sm btn-custom" data-event="jqm" data-param-id="5" data-name="order_services" data-autoload-service="<?=$arItem['NAME']?>"><span><?=(strlen($arParams['S_ORDER_SERVICE']) ? $arParams['S_ORDER_SERVICE'] : GetMessage('S_ORDER_SERVICE'))?></span></span>
									</div>
									<?// element status?>
