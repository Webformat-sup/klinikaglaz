...
?>
<?$APPLICATION->IncludeComponent("bitrix:news", "staff_custom", Array(
	"IBLOCK_TYPE" => "aspro_scorp_content",	// Тип инфоблока
		...
		"SEF_FOLDER" => "/company/staff/",	// Каталог ЧПУ (относительно корня сайта)
		...
		"VIEW_TYPE" => "table",	// Вид отображения
