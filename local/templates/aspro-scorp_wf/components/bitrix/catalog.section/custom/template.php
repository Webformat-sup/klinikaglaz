	...
	<div class="pricelist-container">
		<div class="maxwidth-theme">
			<div class="pricelist-wrapp">
				...
				<div class="pricelist-text user-edit">
					Несмотря на общее название «Имплантация интраокулярной линзы» существует несколько методов провещения этой операции, у каждого из которых своя цена. Врач выбирает метод в зависимости от показаний, сопуствующих заболеваний, состояния глазного яблока и организма на момент вмешательства.
				</div>
				<div class="pricelist-list">

					<!-- item -->
					<div class="item">
						<div class="text">Операция экстракции катаракты (интракапсулярная, экстракапсулярная)</div>
						<div class="price">40 000 ₽</div>
					</div>

					<!-- item -->
					<div class="item">
						<div class="text">Факоэмульсификация неосложненной катаракты</div>
						<div class="price">57 000 ₽</div>
					</div>

				</div>
				<div class="pricelist-footer">
					<div class="text">Цены без учета стоимости линзы (подбирается индивидуально)</div>
				</div>
			</div>
