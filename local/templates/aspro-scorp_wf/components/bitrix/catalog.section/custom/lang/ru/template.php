...
$MESS["CT_NAME_INCLUDE"] = "область над формой Записаться на прием";
$MESS["CT_NAME_INCLUDE_2"] = "область под Прайс-листом";
$MESS["CT_NAME_INCLUDE_3"] = "область в блоке сертификаты";
