	...
	<?if($arResult['SECTIONS']):?>
		<h4>Отзывы</h4>
			...
			<?foreach($arResult['SECTIONS'] as $si => $arSection):?>
				...
				<div  class="flexslider row sid-<?=$arSection['ID']?> items rew" data-plugin-options='{"animation": "slide", "directionNav": true, "controlNav" :false, "animationLoop": true, "slideshow": false, "counts": [1, 1, 1]}'>
				 <ul class="slides">
