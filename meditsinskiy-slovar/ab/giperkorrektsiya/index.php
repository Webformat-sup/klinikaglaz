...
$APPLICATION->SetTitle("Что такое Гиперкоррекция");
$APPLICATION->SetPageProperty("description", "Гиперкоррекция - избыточная величина лазерной абляции, приводящая к смене знака аметропии и снижению послеоперационной остроты зрения.");?><h2>Гиперкоррекция</h2>
<p>
