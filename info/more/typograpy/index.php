...
<div class="row">
	...
	<div class="col-md-6">
		...
		<h3 class="underline">Заголовок блока</h3>
		<h4 class="underline">Заголовок второстепенных блоков</h4>
		<h5 class="underline">Заголовок характеристик</h5>
	</div>
</div>
<hr class="tall" />
<div class="row">
	<div class="col-md-12">
		<h2 class="underline">Drop Caps</h2>
	</div>
</div>
<div class="row">
	<div class="col-md-6">
