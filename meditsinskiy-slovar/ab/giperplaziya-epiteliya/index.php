...
$APPLICATION->SetTitle("Что такое Гиперплазия эпителия");
$APPLICATION->SetPageProperty("description", "Гиперплазия эпителия - утолщение эпителиального пласта в период заживления после лазерной коррекции.");?><h2>Гиперплазия эпителия</h2>
<p>
