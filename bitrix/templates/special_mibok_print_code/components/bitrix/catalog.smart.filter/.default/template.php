...
<div class="help-form-wrapper">
    <button type="button" class="btn btn-default btn-help-form" aria-label="<?=GetMessage("MIBOK_SP_CT_BCSF_FILTER_TITLE")?>" tabindex="0"><span class="glyphicon glyphicon-filter"></span>&nbsp;<?=GetMessage("MIBOK_SP_CT_BCSF_FILTER_TITLE")?></button>
                                    ...
                                    <div class="bx-filter-block" data-role="bx_filter_block">
                                        <div class="row bx-filter-parameters-box-container">
                                            <div class="col-xs-6 bx-filter-parameters-box-container-block bx-left">
                                                <i class="bx-ft-sub"><?=GetMessage("MIBOK_SP_CT_BCSF_FILTER_FROM")?></i>
                                            ...
                                            <div class="col-xs-6 bx-filter-parameters-box-container-block bx-right">
                                                <i class="bx-ft-sub"><?=GetMessage("MIBOK_SP_CT_BCSF_FILTER_TO")?></i>
                                                <div class="bx-filter-input-container">
                                                    <input
                                                        class="max-price"
                                                        type="text"
                                                ...
                                                <?foreach ($arItem["VALUES"] as $val => $ar):?>
                                                    ...
                                                    <label for="<?=$ar["CONTROL_ID"]?>" data-role="label_<?=$ar["CONTROL_ID"]?>" class="bx-filter-param-label <?=$class?>" onclick="smartFilter.keyup(BX('<?=CUtil::JSEscape($ar["CONTROL_ID"])?>')); BX.toggleClass(this, 'bx-active');">
                                                        <span class="bx-filter-param-btn bx-color-sl">
                                                            ...
                                                            <img class="img-responsive" src="<?=$ar["FILE"]["SRC"]?>">
                                                            <?endif?>
                                                        </span>
                                                    </label>
                                                <?endforeach?>
                                                ...
                                                <div class="bx-filter-select-container">
                                                    <div class="bx-filter-select-block" onclick="smartFilter.showDropDownPopup(this, '<?=CUtil::JSEscape($key)?>')">
                                                        <div class="bx-filter-select-text" data-role="currentOption">
                                                            ...
                                                            if (!$checkedItemExist)
                                                            {
                                                                echo GetMessage("MIBOK_SP_CT_BCSF_FILTER_ALL");
                                                            }
                                                            ?>
                                                        </div>
                                                ...
                                                <div class="radio">
                                                    <label class="bx-filter-param-label" for="<? echo "all_".$arCur["CONTROL_ID"] ?>">
                                                        <span class="bx-filter-input-checkbox">
                                                            ...
                                                            />
                                                            <span class="bx-filter-param-text"><? echo GetMessage("MIBOK_SP_CT_BCSF_FILTER_ALL"); ?></span>
                                                        </span>
                                                    </label>
                                                </div>
                                                <?foreach($arItem["VALUES"] as $val => $ar):?>
                            ...
                            <div class="bx-filter-block">
                                <div class="bx-filter-parameters-box-container">
                                    <input
                                        ...
                                        id="set_filter"
                                        name="set_filter"
                                        value="<?=GetMessage("MIBOK_SP_CT_BCSF_SET_FILTER")?>"
                                    />
                                    <input
                                        class="btn btn-default"
                                        type="submit"
                                        id="del_filter"
                                        name="del_filter"
                                        value="<?=GetMessage("MIBOK_SP_CT_BCSF_DEL_FILTER")?>"
                                    />
                                    <div class="bx-filter-popup-result <?if ($arParams["FILTER_VIEW_MODE"] == "VERTICAL") echo $arParams["POPUP_POSITION"]?>" id="modef" <?if(!isset($arResult["ELEMENT_COUNT"])) echo 'style="display:none"';?> style="display: inline-block;">
                                        <?echo GetMessage("MIBOK_SP_CT_BCSF_FILTER_COUNT", array("#ELEMENT_COUNT#" => '<span id="modef_num">'.intval($arResult["ELEMENT_COUNT"]).'</span>'));?>
                                        <span class="arrow"></span>
                                        <br/>
                                        <a href="<?echo $arResult["FILTER_URL"]?>" target="" class='bx-filter-show-link'><?echo GetMessage("MIBOK_SP_CT_BCSF_FILTER_SHOW")?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
