			...
			<div class="form-body">
				<?if(is_array($arResult["QUESTIONS"])):?>
					<?foreach( $arResult["QUESTIONS"] as $FIELD_SID => $arQuestion ){
						if($arQuestion['CODE']=='DOCUMENTS' || $arQuestion['CODE'] =='DISEASE' || $arQuestion['CODE']=='POST'){continue;}
...
<script>
	$(document).ready(function(){
		...
		$('.popup form[name="<?=$arResult["IBLOCK_CODE"]?>"] input.date').inputmask(arScorpOptions['THEME']['DATE_MASK'], { 'placeholder': arScorpOptions['THEME']['DATE_PLACEHOLDER'] });
