...
<div class="element-detail">    
    ...
    <?if($arParams["DISPLAY_PICTURE"]!="N" && is_array($arResult["DETAIL_PICTURE"])):?>
        <?if(!empty($arResult['RESIZE']['src'])):?>    
            <img class="detail_picture img-responsive" border="0" src="<?=$arResult['RESIZE']['src']?>" alt="<?=$arResult["DETAIL_PICTURE"]["ALT"]?>"  title="<?=$arResult["NAME"]?>" />
        <?else:?>
            <img class="detail_picture img-responsive" border="0" src="<?=$arResult["DETAIL_PICTURE"]["SRC"]?>"  alt="<?=$arResult["DETAIL_PICTURE"]["ALT"]?>"  title="<?=$arResult["NAME"]?>" />
        <?endif;?>
    <?endif?>	
