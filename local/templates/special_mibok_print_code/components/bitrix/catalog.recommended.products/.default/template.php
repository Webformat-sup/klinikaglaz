...
if (!empty($arResult['RECOMMENDED_IDS']))
{
	...
	if (empty($arParams['HIDE_BLOCK_TITLE']) || $arParams['HIDE_BLOCK_TITLE'] !== 'Y')
	{
		...
		<div class="bx_item_list_title">
			<?=($arParams['BLOCK_TITLE'] ? htmlspecialcharsbx($arParams['BLOCK_TITLE']) : GetMessage('MIBOK_SP_CATALOG_RECOMMENDED_PRODUCTS_HREF_TITLE'))?>
		</div>
		<?
	}
	...
	$APPLICATION->IncludeComponent(
		...
		'.default',
		array(
            'CATALOG_SECTION_HEADER'=> GetMessage('MIBOK_SP_CATALOG_RECOMMENDED_BY_LINK'),
