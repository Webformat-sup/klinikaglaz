...
$APPLICATION->SetPageProperty("description", "Настоящее Пользовательское Соглашение (Далее Соглашение) регулирует отношения между владельцем klinikaglaz.ru с одной стороны и пользователем сайта с другой");
